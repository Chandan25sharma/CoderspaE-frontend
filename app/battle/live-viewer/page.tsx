  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Live Viewer Dashboard</h1>
                <p className="text-gray-400">Watch Ongoing Battles as Spectator</p>
              </div>
            </div>
          </div>
        ...
        {/* User Table */}
        <div className="mb-8">
          <UserTable battleMode="Live Viewer" />
        </div>

        {/* Problems Table */}
        <ProblemsTable battleMode="Live Viewer" />
        ...
        >
          <p className="text-gray-400 text-sm mb-4">
            Watch live coding battles, learn from experts, and enjoy the thrill of competitive programming!
          </p>
          <div className="flex items-center justify-center gap-6 text-xs text-gray-500">
            <span>• Live battle streaming</span>
