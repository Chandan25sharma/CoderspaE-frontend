...
export default function MirrorArenaPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-black">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Mirror Arena Dashboard</h1>
                <p className="text-gray-400">Same Problem, Different Approaches</p>
              </div>
            </div>
          </div>
        ...
        {/* User Table */}
        <div className="mb-8">
          <UserTable battleMode="Mirror Arena" />
        </div>
        ...
        >
          <p className="text-gray-400 text-sm mb-4">
            Solve the same problem with different approaches. Compare algorithms and optimization techniques!
          </p>
          <div className="flex items-center justify-center gap-6 text-xs text-gray-500">
            <span>• Multiple solutions welcome</span>
